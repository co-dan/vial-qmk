...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_planck_mit(
        ...
        MT(MOD_LCTL, KC_TAB),  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCOLON, KC_ENTER,
        KC_LSHIFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_BACKSLASH,
        KC_TAB,  KC_LCTRL, KC_LALT, KC_LGUI, MO(1),   KC_SPC,  MO(2),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
    ),
    ...
    [2] = LAYOUT_planck_mit(
        ...
        KC_LSFT, KC_LCBR, KC_RCBR, KC_LPRN, KC_RPRN, KC_COLN, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______,
